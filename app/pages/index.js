...
const Home = () => {
    const { initialized, initializeUser, loading, transactionPending, completedTodos, incompleteTodos, addTodo, markTodo, removeTodo, input,  handleChange, addStaticTodo, markStaticTodo, removeStaticTodo, initializeStaticUser } = useTodo()
